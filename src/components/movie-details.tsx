      ...
      <div className="border-b">
        <div className="container mx-auto px-4">
          <div className="flex space-x-8 text-sm">
            <a href="#" className="border-b-2 border-transparent py-4 text-gray-500 hover:text-gray-900">
              Thông tin phim
            </a>
            <a href="#" className="border-b-2 border-red-500 py-4 text-red-500 font-medium">
              Lịch chiếu
            </a>
            <a href="#" className="border-b-2 border-transparent py-4 text-gray-500 hover:text-gray-900">
              Đánh giá
