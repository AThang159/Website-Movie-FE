            ...
            <CardHeader className="space-y-1 pb-6">
              <div className="text-center mb-4">
                ...
                <p className="text-gray-600 mt-2">
                  {isLogin ? "Chào mừng bạn quay trở lại!" : "Tạo tài khoản mới để đặt vé"}
                </p>
              </div>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="text-center">
                  <span className="text-sm text-gray-600">{isLogin ? "Chưa có tài khoản?" : "Đã có tài khoản?"}</span>
                  <button
                    type="button"
                    onClick={switchMode}
                    className="text-sm text-red-600 hover:text-red-700 ml-1 font-medium"
                    disabled={isLoading}
                  >
